...
* Switching between Manual and Schedule modes
...
|Version|Description|
|-|-|
|2.2.0|<ul><li>Major code refactor</li><li>Added Manual switch</li><li>Added Heater Cooler accessory as optional replacement for Thermostat</li><li>Show controller's temperature units in "Hardware Display Units" of Thermostat/Heater Cooler accessory</li><li>Expose TCP close connection delay time as config option</li><li>Added config schema to allow configuration via Homebridge Config UI X</li><li>Removed refresh option</li></ul>|
...
|2.0.0|<ul><li>Added new accessories for Fan, Pump & Advance Period switch</li><li>Use Homebridge dynamic platform instead of single accessory</li><li>Use Thermostat service instead of Heater Cooler</li><li>Zero config option</li><li>Better support for evaporative cooling</li><li>Revamped mapping overrides</li></ul>|
